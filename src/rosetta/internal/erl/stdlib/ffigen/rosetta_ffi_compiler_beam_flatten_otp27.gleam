...
/// beam_flatten:block
/// block to ext_erl_ffigen_beam_flatten_block_1 binding generated automatically by rosettaffigen 
/// This function IS NOT DESIGNED for general use.
@external(erlang, "beam_flatten", "block")
pub fn ext_erl_ffigen_app_compiler_beam_flatten_block_1(
  arg0: Dynamic,
) -> Dynamic
